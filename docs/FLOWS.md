...
| Automatic B&H baseline proof | **Durable state** | The successful inception-is-baseline verification persists its identity and evidence digest; Settings evaluations re-validate the record and serve the proven baseline without replaying history until a bounded invalidation reason fails it closed. |
