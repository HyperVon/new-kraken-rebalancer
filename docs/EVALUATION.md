...
The Kraken Rebalancer includes a production-grade **Scenario Evaluation Suite** designed to verify the correctness, performance, safety, and resilience of the rebalancer under 34 highly realistic market scenarios and operational conditions.
...
| Scenario 18 | Ktor SSE Keep-Alive and Broadcast Resilience | 🟢 **PASS** | SSE stream client successfully connected to a hot replaying flow and received 3 snapshots sequentially:<br>- Snapshot 1 (Initial): SNAP1<br>- Snapshot 2: SNAP2<br>- Snapshot 3: SNAP3 |
...
| Scenario 20 | Missing or Corrupt Stats File Recovery | 🟢 **PASS** | Malformed JSON failed closed with IOException<br>Missing stats file recovered with ATH 0: true<br>New stats saved and verified correctly: true |
...
| Scenario 25 | Minimum Order Size Rejection Recovery | 🟢 **PASS** | Executed order calls: [OrderCall(pair=XBTUSD, type=market, side=buy, volume=0.00600000), OrderCall(pair=ETHUSD, type=market, side=buy, volume=0.15000000)]<br>Captured actions in history snapshot: [Deviation: BTC -100%, Deviation: ETH -100%, Deviation: USD 150%, FAILED BUY BTC: Order minimum size not met, BUY ETH Volume: 0.15 Cost: $300.00]<br>BTC failure logged: true, ETH success logged: true, ETH failure logged: false |
