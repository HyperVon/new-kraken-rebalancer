...
/** Cumulative staking, dividend, promotion, and Earn reward value over time, aligned to portfolio snapshot timestamps. */
...
/** Cumulative staking, dividend, promotion, and Earn reward value at one snapshot time, per asset (USD) and in total (USD). */
