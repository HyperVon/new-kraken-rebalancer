...
| CQ-3-23 | L | bug | done | orders | Skip zero/negative-value orders (`minimumOrderSizeUSD=0` / budget-trimmed `$0`) | 3 | [#73](https://github.com/HyperVon/new-kraken-rebalancer/pull/73) | — |
