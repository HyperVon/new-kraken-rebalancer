...
| :--- | :---: | :--- | :--- | :--- | :--- | :---: | :--- |
| CQ-13-1 | S | gap | done | rate-limit | Enforce cost bounds (`cost > 0.0` and `cost <= safeLimit`) in `RateLimiter` | 13 | #145 |
| CQ-13-2 | S | gap | done | orders | Cover zero price/volume order execution guard paths | 13 | #145 |
| CQ-13-3 | S | gap | done | history/calc | Cover unknown order side handling during timeline reconstruction | 13 | #145 |
| CQ-13-4 | S | gap | done | history/dedupe | Cover zero and negative timestamp delta in trade deduplication | 13 | #145 |
| CQ-13-5 | S | gap | done | frontend-js | Safely parse unknown or malformed `submissionState` strings | 13 | #145 |
