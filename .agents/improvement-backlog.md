...
| :--- | :---: | :--- | :--- | :--- | :---: | :--- |
| CI-19-C1 | S | done | tests | Replace wildcard imports with explicit imports in `DashboardViewTest` and `ConfigServiceTest` | 19 | pending |
| CI-19-D1 | S | done | docs | Update `CHANGELOG.md` for version 6.15.24 release | 19 | pending |
