...
| Kilo model selection and routed subagents | [AGENTIC_DEVELOPMENT.md](../docs/AGENTIC_DEVELOPMENT.md#models-and-adaptive-multi-agent-review) and [route-subagents](../.kilo/model-router/route-subagents) |
