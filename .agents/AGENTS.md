...
| Kilo model selection and cross-provider routing | [AGENTIC_DEVELOPMENT.md](../docs/AGENTIC_DEVELOPMENT.md#models-and-adaptive-multi-agent-review) and [route-kilo](../.kilo/model-router/route-kilo) |
