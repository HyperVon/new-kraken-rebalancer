...
Full guidance: [`.agents/OPERATING.md` § 3 Parallel multi-agent work](../.agents/OPERATING.md).
Deep how-to: [`.agents/skills/parallel-multi-agent/SKILL.md`](../.agents/skills/parallel-multi-agent/SKILL.md).
