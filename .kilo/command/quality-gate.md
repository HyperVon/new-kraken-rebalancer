...
- Run the full JVM, coverage, frontend, and formatting checks:
  ...
  - `npx markdownlint-cli .agents/AGENTS.md .agents/OPERATING.md CLAUDE.md .github/copilot-instructions.md CHANGELOG.md CONTRIBUTING.md README.md SECURITY.md docs/*.md .agents/skills/**/*.md .kilo/command/*.md`
