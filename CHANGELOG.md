...
- **Test Assertions Refactoring**: Updated `DashboardViewTest.kt` to reference centralized `ViewText` variables instead of duplicating hardcoded strings, ensuring cleaner design and easier localization updates.
