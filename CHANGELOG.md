...
- **External JavaScript Resource**: Moved inline table sorting and age update script from `DashboardShellComponent` to `/static/dashboard.js` and added unit testing for static JS delivery.
