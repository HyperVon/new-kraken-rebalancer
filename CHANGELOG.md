...
- **Explicit imports & code hygiene**: Replaced wildcard imports with explicit single-class imports in `PortfolioManagerImpl`, `KrakenServiceImpl`, `DashboardRoutes`, `ErrorHandlingConfig`, `KtorConfig`, and `KrakenRebalancerApplication`.
