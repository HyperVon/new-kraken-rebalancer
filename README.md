...
│   └── skills/                            # Domain skills (code-review, commit-and-push, exposed-repository, frontend-js-development, koin-di-and-config, kotlin-refactoring-and-cleanup, kraken-api-integration, ktor-html-views, portfolio-rebalancing-math, write-kotest, autonomous-code-optimizer)
